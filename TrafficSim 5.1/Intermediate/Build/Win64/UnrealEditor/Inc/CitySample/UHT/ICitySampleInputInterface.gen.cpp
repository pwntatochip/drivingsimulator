...
#include "CitySample/Util/ICitySampleInputInterface.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FInterfacePropertyParams Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::NewProp_SubsystemInterface = { "SubsystemInterface", nullptr, (EPropertyFlags)0x0014000008000182, UECodeGen_Private::EPropertyGenFlags::Interface, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CitySampleInputInterface_eventAddInputContext_Parms, SubsystemInterface), Z_Construct_UClass_UEnhancedInputSubsystemInterface_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::NewProp_SubsystemInterface_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::NewProp_SubsystemInterface_MetaData)) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::Function_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Util/ICitySampleInputInterface.h" },
		{ "ToolTip", "Called to add any necessary inputs." },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCitySampleInputInterface, nullptr, "AddInputContext", nullptr, nullptr, sizeof(CitySampleInputInterface_eventAddInputContext_Parms), Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C420C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext_Statics::Function_MetaDataParams)) };
...
#endif
	const UECodeGen_Private::FInterfacePropertyParams Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext_Statics::NewProp_SubsystemInterface = { "SubsystemInterface", nullptr, (EPropertyFlags)0x0014000008000182, UECodeGen_Private::EPropertyGenFlags::Interface, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CitySampleInputInterface_eventRemoveInputContext_Parms, SubsystemInterface), Z_Construct_UClass_UEnhancedInputSubsystemInterface_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext_Statics::NewProp_SubsystemInterface_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext_Statics::NewProp_SubsystemInterface_MetaData)) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCitySampleInputInterface, nullptr, "RemoveInputContext", nullptr, nullptr, sizeof(CitySampleInputInterface_eventRemoveInputContext_Parms), Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C420C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCitySampleInputInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCitySampleInputInterface_AddInputContext, "AddInputContext" }, // 2926073293
		{ &Z_Construct_UFunction_UCitySampleInputInterface_RemoveInputContext, "RemoveInputContext" }, // 3297089165
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCitySampleInputInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(Z_Construct_UClass_UCitySampleInputInterface_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UCitySampleInputInterface_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_ICitySampleInputInterface_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_ICitySampleInputInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCitySampleInputInterface, UCitySampleInputInterface::StaticClass, TEXT("UCitySampleInputInterface"), &Z_Registration_Info_UClass_UCitySampleInputInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCitySampleInputInterface), 718015800U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_ICitySampleInputInterface_h_1386544913(TEXT("/Script/CitySample"),
		Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_ICitySampleInputInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_ICitySampleInputInterface_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
