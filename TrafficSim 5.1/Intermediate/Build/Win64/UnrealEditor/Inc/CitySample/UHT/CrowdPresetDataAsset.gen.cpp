...
#include "CitySample/Crowd/CrowdPresetDataAsset.h"
...
class UScriptStruct* FCrowdPreset::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CrowdPreset.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCrowdPreset, Z_Construct_UPackage__Script_CitySample(), TEXT("CrowdPreset"));
	}
...
template<> CITYSAMPLE_API UScriptStruct* StaticStruct<FCrowdPreset>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FCrowdPreset_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Crowd/CrowdPresetDataAsset.h" },
	};
#endif
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FCrowdPreset, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_CharacterOptions = { "CharacterOptions", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FCrowdPreset, CharacterOptions), Z_Construct_UScriptStruct_FCrowdCharacterOptions, METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_CharacterOptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_CharacterOptions_MetaData)) }; // 359127656
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_Meshes_Inner = { "Meshes", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_Meshes = { "Meshes", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FCrowdPreset, Meshes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_Meshes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewProp_Meshes_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdPreset_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdPreset_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdPreset_Statics::Struct_MetaDataParams))
	};
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCrowdPresetDataAsset_Statics::NewProp_Presets_Inner = { "Presets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FCrowdPreset, METADATA_PARAMS(nullptr, 0) }; // 312153500
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCrowdPresetDataAsset_Statics::NewProp_Presets = { "Presets", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UCrowdPresetDataAsset, Presets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCrowdPresetDataAsset_Statics::NewProp_Presets_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdPresetDataAsset_Statics::NewProp_Presets_MetaData)) }; // 312153500
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCrowdPresetDataAsset_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UCrowdPresetDataAsset_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdPresetDataAsset_Statics::Class_MetaDataParams))
	};
...
class UScriptStruct* FCrowdVATPreset::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CrowdVATPreset.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCrowdVATPreset, Z_Construct_UPackage__Script_CitySample(), TEXT("CrowdVATPreset"));
	}
...
template<> CITYSAMPLE_API UScriptStruct* StaticStruct<FCrowdVATPreset>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::NewProp_AnimToTextureAsset = { "AnimToTextureAsset", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FCrowdVATPreset, AnimToTextureAsset), Z_Construct_UClass_UAnimToTextureDataAsset_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::NewProp_AnimToTextureAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::NewProp_AnimToTextureAsset_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::Struct_MetaDataParams))
	};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset_Statics::NewProp_CrowdPresetDataAsset = { "CrowdPresetDataAsset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CrowdVATPresetDataAsset_eventCopyFromCrowdPreset_Parms, CrowdPresetDataAsset), Z_Construct_UClass_UCrowdPresetDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset_Statics::NewProp_ValidationAsset = { "ValidationAsset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CrowdVATPresetDataAsset_eventCopyFromCrowdPreset_Parms, ValidationAsset), Z_Construct_UClass_UCrowdCharacterDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCrowdVATPresetDataAsset, nullptr, "CopyFromCrowdPreset", nullptr, nullptr, sizeof(Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset_Statics::CrowdVATPresetDataAsset_eventCopyFromCrowdPreset_Parms), Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable_Statics::NewProp_DriverTypesDataAsset = { "DriverTypesDataAsset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CrowdVATPresetDataAsset_eventCopyToDataTable_Parms, DriverTypesDataAsset), Z_Construct_UClass_UMassTrafficDriverTypesDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCrowdVATPresetDataAsset, nullptr, "CopyToDataTable", nullptr, nullptr, sizeof(Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable_Statics::CrowdVATPresetDataAsset_eventCopyToDataTable_Parms), Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::NewProp_CrowdDataAsset = { "CrowdDataAsset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CrowdVATPresetDataAsset_eventRandomize_Parms, CrowdDataAsset), Z_Construct_UClass_UCrowdCharacterDataAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::NewProp_NumPresets = { "NumPresets", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CrowdVATPresetDataAsset_eventRandomize_Parms, NumPresets), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::NewProp_BaseOptions = { "BaseOptions", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CrowdVATPresetDataAsset_eventRandomize_Parms, BaseOptions), Z_Construct_UScriptStruct_FCrowdCharacterOptions, METADATA_PARAMS(Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::NewProp_BaseOptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::NewProp_BaseOptions_MetaData)) }; // 359127656
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::NewProp_FixedOptions = { "FixedOptions", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CrowdVATPresetDataAsset_eventRandomize_Parms, FixedOptions), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 3444908126
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCrowdVATPresetDataAsset, nullptr, "Randomize", nullptr, nullptr, sizeof(Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::CrowdVATPresetDataAsset_eventRandomize_Parms), Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyFromCrowdPreset, "CopyFromCrowdPreset" }, // 160147333
		{ &Z_Construct_UFunction_UCrowdVATPresetDataAsset_CopyToDataTable, "CopyToDataTable" }, // 2822195169
		{ &Z_Construct_UFunction_UCrowdVATPresetDataAsset_Randomize, "Randomize" }, // 4118125291
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::NewProp_Presets_Inner = { "Presets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FCrowdVATPreset, METADATA_PARAMS(nullptr, 0) }; // 3216770733
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::NewProp_Presets = { "Presets", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UCrowdVATPresetDataAsset, Presets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::NewProp_Presets_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::NewProp_Presets_MetaData)) }; // 3216770733
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdVATPresetDataAsset_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdPresetDataAsset_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdPresetDataAsset_h_Statics::ScriptStructInfo[] = {
		{ FCrowdPreset::StaticStruct, Z_Construct_UScriptStruct_FCrowdPreset_Statics::NewStructOps, TEXT("CrowdPreset"), &Z_Registration_Info_UScriptStruct_CrowdPreset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdPreset), 312153500U) },
		{ FCrowdVATPreset::StaticStruct, Z_Construct_UScriptStruct_FCrowdVATPreset_Statics::NewStructOps, TEXT("CrowdVATPreset"), &Z_Registration_Info_UScriptStruct_CrowdVATPreset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdVATPreset), 3216770733U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdPresetDataAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCrowdPresetDataAsset, UCrowdPresetDataAsset::StaticClass, TEXT("UCrowdPresetDataAsset"), &Z_Registration_Info_UClass_UCrowdPresetDataAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCrowdPresetDataAsset), 4087437487U) },
		{ Z_Construct_UClass_UCrowdVATPresetDataAsset, UCrowdVATPresetDataAsset::StaticClass, TEXT("UCrowdVATPresetDataAsset"), &Z_Registration_Info_UClass_UCrowdVATPresetDataAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCrowdVATPresetDataAsset), 690691265U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdPresetDataAsset_h_3857166985(TEXT("/Script/CitySample"),
		Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdPresetDataAsset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdPresetDataAsset_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdPresetDataAsset_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdPresetDataAsset_h_Statics::ScriptStructInfo),
		nullptr, 0);
