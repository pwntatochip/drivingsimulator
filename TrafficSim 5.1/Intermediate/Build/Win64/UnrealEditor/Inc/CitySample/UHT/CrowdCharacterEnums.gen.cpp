...
#include "CitySample/Crowd/CrowdCharacterEnums.h"
...
// End Cross Module References
	...
	static UEnum* ECitySampleCrowdGender_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECitySampleCrowdGender.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_ECitySampleCrowdGender, Z_Construct_UPackage__Script_CitySample(), TEXT("ECitySampleCrowdGender"));
		}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_CitySample_ECitySampleCrowdGender_Statics::Enum_MetaDataParams[] = {
		...
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Crowd/CrowdCharacterEnums.h" },
	};
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_ECitySampleCrowdGender_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_ECitySampleCrowdGender_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_ECitySampleCrowdGender_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ECitySampleCrowdBodyType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECitySampleCrowdBodyType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_ECitySampleCrowdBodyType, Z_Construct_UPackage__Script_CitySample(), TEXT("ECitySampleCrowdBodyType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_ECitySampleCrowdBodyType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_ECitySampleCrowdBodyType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_ECitySampleCrowdBodyType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ECrowdHairSlots_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECrowdHairSlots.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_ECrowdHairSlots, Z_Construct_UPackage__Script_CitySample(), TEXT("ECrowdHairSlots"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_ECrowdHairSlots_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_ECrowdHairSlots_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_ECrowdHairSlots_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ECrowdMeshSlots_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECrowdMeshSlots.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_ECrowdMeshSlots, Z_Construct_UPackage__Script_CitySample(), TEXT("ECrowdMeshSlots"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_ECrowdMeshSlots_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_ECrowdMeshSlots_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_ECrowdMeshSlots_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ECrowdLineupVariation_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECrowdLineupVariation.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_ECrowdLineupVariation, Z_Construct_UPackage__Script_CitySample(), TEXT("ECrowdLineupVariation"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_ECrowdLineupVariation_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_ECrowdLineupVariation_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_ECrowdLineupVariation_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ECharacterDefinitionType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECharacterDefinitionType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_ECharacterDefinitionType, Z_Construct_UPackage__Script_CitySample(), TEXT("ECharacterDefinitionType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_ECharacterDefinitionType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_ECharacterDefinitionType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_ECharacterDefinitionType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ECrowdMaterialParameterType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECrowdMaterialParameterType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_ECrowdMaterialParameterType, Z_Construct_UPackage__Script_CitySample(), TEXT("ECrowdMaterialParameterType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_ECrowdMaterialParameterType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_ECrowdMaterialParameterType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_ECrowdMaterialParameterType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ECrowdPatternUsage_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECrowdPatternUsage.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_ECrowdPatternUsage, Z_Construct_UPackage__Script_CitySample(), TEXT("ECrowdPatternUsage"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_ECrowdPatternUsage_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_ECrowdPatternUsage_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_ECrowdPatternUsage_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* EAnimToTextureDataAssetSlots_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAnimToTextureDataAssetSlots.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_CitySample_EAnimToTextureDataAssetSlots, Z_Construct_UPackage__Script_CitySample(), TEXT("EAnimToTextureDataAssetSlots"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CitySample_EAnimToTextureDataAssetSlots_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_CitySample_EAnimToTextureDataAssetSlots_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CitySample_EAnimToTextureDataAssetSlots_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdCharacterEnums_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdCharacterEnums_h_Statics::EnumInfo[] = {
		{ ECitySampleCrowdGender_StaticEnum, TEXT("ECitySampleCrowdGender"), &Z_Registration_Info_UEnum_ECitySampleCrowdGender, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2300556037U) },
		{ ECitySampleCrowdBodyType_StaticEnum, TEXT("ECitySampleCrowdBodyType"), &Z_Registration_Info_UEnum_ECitySampleCrowdBodyType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1226486887U) },
		{ ECrowdHairSlots_StaticEnum, TEXT("ECrowdHairSlots"), &Z_Registration_Info_UEnum_ECrowdHairSlots, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 232860032U) },
		{ ECrowdMeshSlots_StaticEnum, TEXT("ECrowdMeshSlots"), &Z_Registration_Info_UEnum_ECrowdMeshSlots, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2078659843U) },
		{ ECrowdLineupVariation_StaticEnum, TEXT("ECrowdLineupVariation"), &Z_Registration_Info_UEnum_ECrowdLineupVariation, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3444908126U) },
		{ ECharacterDefinitionType_StaticEnum, TEXT("ECharacterDefinitionType"), &Z_Registration_Info_UEnum_ECharacterDefinitionType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 794179521U) },
		{ ECrowdMaterialParameterType_StaticEnum, TEXT("ECrowdMaterialParameterType"), &Z_Registration_Info_UEnum_ECrowdMaterialParameterType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1879032620U) },
		{ ECrowdPatternUsage_StaticEnum, TEXT("ECrowdPatternUsage"), &Z_Registration_Info_UEnum_ECrowdPatternUsage, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2609121898U) },
		{ EAnimToTextureDataAssetSlots_StaticEnum, TEXT("EAnimToTextureDataAssetSlots"), &Z_Registration_Info_UEnum_EAnimToTextureDataAssetSlots, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1303225488U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdCharacterEnums_h_693317154(TEXT("/Script/CitySample"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdCharacterEnums_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Crowd_CrowdCharacterEnums_h_Statics::EnumInfo));
