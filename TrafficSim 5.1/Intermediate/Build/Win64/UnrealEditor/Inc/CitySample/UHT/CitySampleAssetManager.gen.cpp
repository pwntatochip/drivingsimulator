...
#include "CitySample/Util/CitySampleAssetManager.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCitySampleAssetManager_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Util/CitySampleAssetManager.h" },
		{ "ToolTip", "See docs https://docs.unrealengine.com/4.26/en-US/ProductionPipelines/AssetManagement/\n\nWe set this as our AssetManager in Config/DefaultEngine.ini." },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UCitySampleAssetManager_Statics::NewProp_PlatformBundleState_Inner = { "PlatformBundleState", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCitySampleAssetManager_Statics::NewProp_PlatformBundleState = { "PlatformBundleState", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UCitySampleAssetManager, PlatformBundleState), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCitySampleAssetManager_Statics::NewProp_PlatformBundleState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCitySampleAssetManager_Statics::NewProp_PlatformBundleState_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCitySampleAssetManager_Statics::NewProp_DefaultBundleState = { "DefaultBundleState", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UCitySampleAssetManager, DefaultBundleState), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCitySampleAssetManager_Statics::NewProp_DefaultBundleState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCitySampleAssetManager_Statics::NewProp_DefaultBundleState_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCitySampleAssetManager_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UCitySampleAssetManager_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UCitySampleAssetManager_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleAssetManager_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleAssetManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCitySampleAssetManager, UCitySampleAssetManager::StaticClass, TEXT("UCitySampleAssetManager"), &Z_Registration_Info_UClass_UCitySampleAssetManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCitySampleAssetManager), 1026832388U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleAssetManager_h_1069072129(TEXT("/Script/CitySample"),
		Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleAssetManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleAssetManager_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
