...
#include "CitySample/Game/ICitySampleTraversalInterface.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCitySampleTraversalInterface_GetTraversalState_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CitySampleTraversalInterface_eventGetTraversalState_Parms, ReturnValue), Z_Construct_UEnum_CitySample_EPlayerTraversalState, METADATA_PARAMS(nullptr, 0) }; // 2296943739
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCitySampleTraversalInterface_GetTraversalState_Statics::Function_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Game/ICitySampleTraversalInterface.h" },
		{ "ToolTip", "Called to determine the type of traversal mode this instance provides." },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCitySampleTraversalInterface_GetTraversalState_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCitySampleTraversalInterface, nullptr, "GetTraversalState", nullptr, nullptr, sizeof(CitySampleTraversalInterface_eventGetTraversalState_Parms), Z_Construct_UFunction_UCitySampleTraversalInterface_GetTraversalState_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCitySampleTraversalInterface_GetTraversalState_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCitySampleTraversalInterface_GetTraversalState_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCitySampleTraversalInterface_GetTraversalState_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCitySampleTraversalInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCitySampleTraversalInterface_GetTraversalState, "GetTraversalState" }, // 452758153
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCitySampleTraversalInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(Z_Construct_UClass_UCitySampleTraversalInterface_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UCitySampleTraversalInterface_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Game_ICitySampleTraversalInterface_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Game_ICitySampleTraversalInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCitySampleTraversalInterface, UCitySampleTraversalInterface::StaticClass, TEXT("UCitySampleTraversalInterface"), &Z_Registration_Info_UClass_UCitySampleTraversalInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCitySampleTraversalInterface), 1092184915U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Game_ICitySampleTraversalInterface_h_1114587471(TEXT("/Script/CitySample"),
		Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Game_ICitySampleTraversalInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Game_ICitySampleTraversalInterface_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
