...
class UScriptStruct* FCitySampleRumbleInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CitySampleRumbleInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCitySampleRumbleInfo, Z_Construct_UPackage__Script_CitySample(), TEXT("CitySampleRumbleInfo"));
	}
...
template<> CITYSAMPLE_API UScriptStruct* StaticStruct<FCitySampleRumbleInfo>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::Struct_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Util/CitySampleRumbleInfo.h" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FCitySampleRumbleInfo, Duration), METADATA_PARAMS(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_Duration_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_Duration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_Intensity = { "Intensity", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FCitySampleRumbleInfo, Intensity), METADATA_PARAMS(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_Intensity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_Intensity_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseRightLarge = { "bUseRightLarge", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FCitySampleRumbleInfo), &Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseRightLarge_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseRightLarge_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseRightLarge_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseRightSmall = { "bUseRightSmall", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FCitySampleRumbleInfo), &Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseRightSmall_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseRightSmall_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseRightSmall_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseLeftLarge = { "bUseLeftLarge", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FCitySampleRumbleInfo), &Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseLeftLarge_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseLeftLarge_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseLeftLarge_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseLeftSmall = { "bUseLeftSmall", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FCitySampleRumbleInfo), &Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseLeftSmall_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseLeftSmall_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewProp_bUseLeftSmall_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::Struct_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleRumbleInfo_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleRumbleInfo_h_Statics::ScriptStructInfo[] = {
		{ FCitySampleRumbleInfo::StaticStruct, Z_Construct_UScriptStruct_FCitySampleRumbleInfo_Statics::NewStructOps, TEXT("CitySampleRumbleInfo"), &Z_Registration_Info_UScriptStruct_CitySampleRumbleInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCitySampleRumbleInfo), 55265300U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleRumbleInfo_h_3406067983(TEXT("/Script/CitySample"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleRumbleInfo_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ddamiano_Documents_TrafficSim_5_1_Source_CitySample_Util_CitySampleRumbleInfo_h_Statics::ScriptStructInfo),
		nullptr, 0);
